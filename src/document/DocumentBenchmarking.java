				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 for (int i = 0; i < trials; i++) {
				 // create new basic document
				 BasicDocument bd = new BasicDocument(text);
				 // flesh score
				 double bf = bd.getFleschScore();
			 }
			 long basicEndTime = System.nanoTime();
			 double basicTimeInterval = basicEndTime - basicStartTime;
			 System.out.print(basicTimeInterval / 1000000 + "\t");
			 
			 // efficient document
			 long effStartTime = System.nanoTime();
			 for (int i = 0; i < trials; i++) {
				 EfficientDocument ed = new EfficientDocument(text);
				 double ef = ed.getFleschScore();
			 }
			 long effEndTime = System.nanoTime();
			 double effTimeInterval = effEndTime - effStartTime;
			 System.out.println(effTimeInterval / 1000000 + "\t");
		}
